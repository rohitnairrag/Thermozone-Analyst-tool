 ...
 *
 * Schedule presets (all based on a typical 9-to-6 Indian office):
 *   office_occupancy  – people ramp-up 8→9, full 10-16, ramp-down 17→18, zero after 18
...
export function computeScheduledInternalLoads(
  ...
  for (const item of items) {
    ...
    const watts  = item.count * item.wattsPerUnit * factor;
